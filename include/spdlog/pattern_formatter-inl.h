...
public:
    ...
    void format(const details::log_msg &msg, const std::tm &, memory_buf_t &dest) override
    {
        ...
        if (padinfo_.enabled())
        {
            // calc text char_stream_size for padding based on "filename:line"
...
#    pragma warning(disable : 4127) // consider using 'if constexpr' instead
    ...
    {
        // if the char_stream_size is 2 (1 character + null terminator) we can use the more efficient strrchr
