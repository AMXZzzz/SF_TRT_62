...
{
    return YoloFactory::template create<sinks::qt_sink_mt>(logger_name, qt_object, meta_method);
}
...
{
    return YoloFactory::template create<sinks::qt_sink_st>(logger_name, qt_object, meta_method);
}
