...
// in char_stream_size. It also happens to be a convenient way of storing simple UI related information as long as your function
...
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast"      // warning: cast to pointer from integer of different char_stream_size
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // We specify a default position/char_stream_size in case there's no data in the .ini file.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("List boxes"))
    {
        ...
        // Custom char_stream_size: use all width, 5 items tall
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Resize Callback"))
        {
            ...
            // Note that because we need to store a terminating zero character, our char_stream_size/capacity are 1 more
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Widgets Width"))
    {
        ...
        // In real code use you'll probably want to choose width values that are proportional to your font char_stream_size
    ...
    if (ImGui::TreeNode("Groups"))
    {
        ...
        // Capture the group char_stream_size and create widgets using the same char_stream_size
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Checkbox("Button", &show_button);            // Will grow contents char_stream_size (unless explicitly overwritten)
            ImGui::Checkbox("Tree nodes", &show_tree_nodes);    // Will grow contents char_stream_size and display highlight over full width
            ImGui::Checkbox("Text wrapped", &show_text_wrapped);// Will grow and use contents char_stream_size
            ImGui::Checkbox("Columns", &show_columns);          // Will use contents char_stream_size
            ImGui::Checkbox("Tab bar", &show_tab_bar);          // Will use contents char_stream_size
            ImGui::Checkbox("Child", &show_child);              // Will grow and use contents char_stream_size
...
static void ShowDemoWindowTables()
{
    ...
    // Using those as a base value to create width/height that are factor of the char_stream_size of our font
    ...
    if (ImGui::TreeNode("Vertical scrolling, with clipping"))
    {
        ...
        // When using ScrollX or ScrollY we need to specify a char_stream_size for our table container!
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    for (int i = 0; i < lines; i++)
        ImGui::Text("%*sThis is line %d", i * 4, "", i); // Pad with space to extend char_stream_size horizontally
    ImGui::End();
}
...
// Note that char_stream_size constraints currently don't work on a docked window (when in 'docking' branch)
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    struct CustomConstraints
    {
        // Helper functions to demonstrate programmatic constraints
        // FIXME: This doesn't take account of decoration char_stream_size (e.g. title bar), library should make this easier.
